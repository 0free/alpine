...
#!/bin/sh
PS1="\[\e[31m\][\[\e[m\]\[\e[38;5;172m\]\u\[\e[m\]@\[\e[38;5;153m\]\w\[\e[m\]\[\e[38;5;214m\]\W\[\e[m\]\[\e[31m\]]\[\e[m\]\\$ "
export update='apk update && apk upgrade'
export alpine='curl -LO https://raw.githubusercontent.com/0free/alpine/1/install && bash install'
EOF
